        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-primary">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="/fpUsernameSubmit">
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control" placeholder="Username" name="username" type="text" autofocus
                                       required title="Please Enter Username">
                            </div>
                            <!-- Change this to a button or input when using this as a form -->
                            <input type="submit" class="btn btn-md btn-success"
                                   style="width: 45%;float: left;margin-right: 30px" value="Reset Password"/>
                            <a href="/" class="btn btn-md btn-info" style="width: 45%">Back</a>
                        </fieldset>
                    </form>
                </div>
            </div>
...
<%
    if (request.getAttribute("message") != null && request.getAttribute("message").equals("Username Does not Exists")) {
        out.print(printAlert.getAlertBox("Invalid Username",
